      ...
      <div>
        <div className="mt-1">
          <input
            ...
            placeholder="Title"
            value={element.label || ""}
            onChange={(e) => setElementAttribute("title", e.target.value)}
        ...
        <div className="mt-2">
          <input
            ...
            value={element.help || ""}
            onChange={(e) => setElementAttribute("description", e.target.value)}
            onBlur={() => persistForm(form)}
          />
        </div>
        <div className="mt-2">
          <textarea
            ...
            onChange={(e) => setElementAttribute("body", e.target.value)}
            onBlur={() => persistForm(form)}
          />
        </div>
      </div>
